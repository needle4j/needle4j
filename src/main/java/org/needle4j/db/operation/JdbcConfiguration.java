...
public class JdbcConfiguration {
   ...
   *
   * @param jdbcUrl      the JDBC connection url to use to connect to the database
   * @param jdbcDriver   the name of a JDBC driver to use to connect to the database
   * @param jdbcUser     the JDBC connection user name
   * @param jdbcPassword the JDBC connection password
   */
